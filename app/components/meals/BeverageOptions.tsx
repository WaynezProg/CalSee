...
export function BeverageOptions({
  ...
  return (
    <div className="mt-3 space-y-3 rounded-lg border border-amber-200 bg-amber-50 p-3">
      {/* Sweetness Level */}
      <div>
        <p className="mb-2 text-xs font-medium text-amber-800">{t('beverageOptions.sugarLevel')}</p>
      ...
      {/* Ice Level */}
      <div>
        <p className="mb-2 text-xs font-medium text-amber-800">{t('beverageOptions.iceLevel')}</p>
        <div className="flex flex-wrap gap-1.5">
